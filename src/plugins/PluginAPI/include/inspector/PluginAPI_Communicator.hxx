...
#ifndef PluginAPI_Communicator_H
#define PluginAPI_Communicator_H
...
public:
  ...
  Standard_EXPORT virtual void SetParameters(
    const Handle(PluginAPI_PluginParameters)& theParameters) = 0;
  ...
  virtual void GetPreferences(PluginAPI_PreferencesDataMap&) {}

  //! Applies plugin preferences, empty implementation by default
  virtual void SetPreferences(const PluginAPI_PreferencesDataMap&) {}
  ...
  //! Destructor
  virtual ~PluginAPI_Communicator() {}
};
...
extern "C"
{
  ...
  typedef PluginAPI_Communicator* (*COMMUNICATOR_INSTANCE)();
}
