...
#ifndef PluginAPI_PluginParameters_H
#define PluginAPI_PluginParameters_H
...
#include <inspector/PluginAPI_PreferencesDataMap.hxx>
...
class PluginAPI_PluginParameters : public Standard_Transient
{
public:
  //! Constructs the container.
  Standard_EXPORT PluginAPI_PluginParameters() {}

  //! Destructor
  Standard_EXPORT virtual ~PluginAPI_PluginParameters() {}
  ...
  Standard_EXPORT virtual void GetPreferences(const TCollection_AsciiString&    thePluginName,
                                              PluginAPI_PreferencesDataMap& theItem) = 0;
  ...
  Standard_EXPORT virtual void SetPreferences(const TCollection_AsciiString&          thePluginName,
                                              const PluginAPI_PreferencesDataMap& theItem) = 0;
  ...
  DEFINE_STANDARD_RTTIEXT(PluginAPI_PluginParameters, Standard_Transient)
private:
