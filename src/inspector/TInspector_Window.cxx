...
void TInspector_Window::ActivateTool(const TCollection_AsciiString& thePluginName)
{
  ...
  {
    // apply preferences
    PluginAPI_PreferencesDataMap aPreferences;
...
void TInspector_Window::SetSelected(const NCollection_List<TCollection_AsciiString>& theItemNames)
{
  ...
  PluginAPI_Communicator* aCommunicator = anInfo.myCommunicator;
  if (aCommunicator)
  {
                                   ...
                                   TInspector_ToolInfo&           theInfo)
{
  ...
  PluginAPI_Communicator* aCommunicator =
    PluginAPI_Communicator::LoadPluginLibrary(thePluginName);
...
// purpose :
// =======================================================================
void TInspector_Window::GetPreferences(PluginAPI_PreferencesDataMap& theItem)
{
...
// purpose :
// =======================================================================
void TInspector_Window::SetPreferences(const PluginAPI_PreferencesDataMap& theItem)
{
...
void TInspector_Window::OnRemovePreferences()
{
  ...
  for (int aToolId = 0, aSize = myToolNames.size(); aToolId < aSize; aToolId++)
  {
    ...
    if (!anInfo.myCommunicator)
      continue;
    anInfo.myCommunicator->SetPreferences(PluginAPI_PreferencesDataMap());
  }
}
