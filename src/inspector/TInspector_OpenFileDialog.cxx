...
{
  Handle(PluginAPI_PluginParameters) aParameters = theCommunicator->GetPluginParameters();
  PluginAPI_PreferencesDataMap       aPreferencesItem;
...
#include <Standard_WarningsDisable.hxx>
    ...
    theFileNames = QString(anItemIt.Value().ToCString()).split(";", Qt::SkipEmptyParts);
    #else
