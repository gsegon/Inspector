...
void TInspector_Preferences::GetPreferences(const TCollection_AsciiString&    thePluginName,
                                            PluginAPI_PreferencesDataMap& theItem)
{
...
void TInspector_Preferences::StorePreferences()
{
  ...
  for (NCollection_DataMap<TCollection_AsciiString, PluginAPI_PreferencesDataMap>::Iterator
       ...
       aPrefsIt.Next())
  {
    ...
    const PluginAPI_PreferencesDataMap& aPluginMap = aPrefsIt.Value();
...
void TInspector_Preferences::loadPreferences()
{
  ...
  while (!aPluginNode.isNull())
  {
    if (aPluginNode.isElement())
    {
      ...
      {
        PluginAPI_PreferencesDataMap anItem;
