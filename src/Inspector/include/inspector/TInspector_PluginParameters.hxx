...
//! parameters
class TInspector_PluginParameters : public PluginAPI_PluginParameters
{
public:
  //! Constructor
  ...
  virtual void GetPreferences(const TCollection_AsciiString&    thePluginName,
                              PluginAPI_PreferencesDataMap& theItem) Standard_OVERRIDE
  {
  ...
  virtual void SetPreferences(const TCollection_AsciiString&          thePluginName,
                              const PluginAPI_PreferencesDataMap& theItem) Standard_OVERRIDE
  {
